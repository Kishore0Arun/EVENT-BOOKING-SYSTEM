<?php
	...
	$stmt = $con->prepare("INSERT INTO photo (uid, location, date, time, phototype, photoprice) VALUES (?, ?, ?, ?, ?, ?)");
	$stmt->bind_param("ssssss", $uid, $location, $date, $time, $ptype, $pprice);
	$stmt->execute();
?>
							...
							<div class="text-middle">
								<div class="row">
									<div class="col-md-6 col-md-offset-3 p-30 background-white">
										...
										<div class="col-md-4 form-group">
											<center><h5>Photography Type:</h5></center>
										</div>
										
										<div class="col-md-8 form-group">
											<input type="text"  value="<?php echo $ptype;   ?>" class="form-control input-lg" disabled>
										</div>
