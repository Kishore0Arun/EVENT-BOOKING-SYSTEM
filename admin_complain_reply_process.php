		...
		<div class="text-middle">
			<div class="row">
				...
				<?php
					...
					$mail->Username = 'arunkishore9845@gmail.com';          	// SMTP username
					$mail->Password = '007arun007'; 					// SMTP password
					$mail->SMTPSecure = 'tls';                         	// Enable TLS encryption, `ssl` also accepted
					$mail->Port = 587;                                 	// TCP port to connect to

					$mail->setFrom('arunkishore9845@gmail.com', 'N_K_Events');
					$mail->addReplyTo('arunkishore9845@gmail.com', 'N_K_Events');
					...
					$mail->Subject = 'Email from N K Events';
