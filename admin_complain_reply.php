...
<body class="wide">
	...
	<!-- SECTION -->
	<form action="admin_complain_reply_process.php" method="POST">
			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3 p-30 background-white">
						...
						<div class="col-md-12 form-group">
							<textarea name="body" row="10" placeholder="Complain / Feedback" class="form-control input-lg" required>  </textarea>
